...
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_products_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_products_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  name VARCHAR(255),
  sku VARCHAR(100),
  imageUrl VARCHAR(255),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_products_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `products`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `products` TO `__schema_sync_old_products_20260406_231853`, `__schema_sync_new_products_20260406_231853` TO `products`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_product_images_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_product_images_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  productId VARCHAR(64),
  url TEXT,
  isPrimary TINYINT(1) DEFAULT 0,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_product_images_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `product_images`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `product_images` TO `__schema_sync_old_product_images_20260406_231853`, `__schema_sync_new_product_images_20260406_231853` TO `product_images`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_orders_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_orders_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  number VARCHAR(100),
  status VARCHAR(50),
  customerName VARCHAR(255),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_orders_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `orders`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `orders` TO `__schema_sync_old_orders_20260406_231853`, `__schema_sync_new_orders_20260406_231853` TO `orders`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_product_variants_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_product_variants_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  productId VARCHAR(64),
  name VARCHAR(255),
  sku VARCHAR(100),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_product_variants_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `product_variants`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `product_variants` TO `__schema_sync_old_product_variants_20260406_231853`, `__schema_sync_new_product_variants_20260406_231853` TO `product_variants`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_product_associations_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_product_associations_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  productId VARCHAR(64),
  relatedProductId VARCHAR(64),
  sortOrder INT,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_product_associations_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `product_associations`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `product_associations` TO `__schema_sync_old_product_associations_20260406_231853`, `__schema_sync_new_product_associations_20260406_231853` TO `product_associations`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_carts_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_carts_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  userId VARCHAR(64),
  status VARCHAR(50),
  createdAt DATETIME,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_carts_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `carts`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `carts` TO `__schema_sync_old_carts_20260406_231853`, `__schema_sync_new_carts_20260406_231853` TO `carts`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_cart_items_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_cart_items_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  cartId VARCHAR(64),
  productId VARCHAR(64),
  variantId VARCHAR(64),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_cart_items_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `cart_items`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `cart_items` TO `__schema_sync_old_cart_items_20260406_231853`, `__schema_sync_new_cart_items_20260406_231853` TO `cart_items`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_cart_accounting_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_cart_accounting_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  cartId VARCHAR(64),
  clientId VARCHAR(64),
  groupsJson MEDIUMTEXT,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_cart_accounting_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `cart_accounting`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `cart_accounting` TO `__schema_sync_old_cart_accounting_20260406_231853`, `__schema_sync_new_cart_accounting_20260406_231853` TO `cart_accounting`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_order_items_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_order_items_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  orderId VARCHAR(64),
  productId VARCHAR(64),
  variantId VARCHAR(64),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_order_items_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `order_items`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `order_items` TO `__schema_sync_old_order_items_20260406_231853`, `__schema_sync_new_order_items_20260406_231853` TO `order_items`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_order_accounting_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_order_accounting_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  orderId VARCHAR(64),
  clientId VARCHAR(64),
  groupsJson MEDIUMTEXT,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_order_accounting_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `order_accounting`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `order_accounting` TO `__schema_sync_old_order_accounting_20260406_231853`, `__schema_sync_new_order_accounting_20260406_231853` TO `order_accounting`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_favorites_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_favorites_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  userId VARCHAR(64),
  productId VARCHAR(64),
  createdAt DATETIME,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_favorites_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `favorites`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `favorites` TO `__schema_sync_old_favorites_20260406_231853`, `__schema_sync_new_favorites_20260406_231853` TO `favorites`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_favorite_categories_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_favorite_categories_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  userId VARCHAR(64),
  name VARCHAR(120),
  sortOrder INT,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_favorite_categories_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `favorite_categories`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `favorite_categories` TO `__schema_sync_old_favorite_categories_20260406_231853`, `__schema_sync_new_favorite_categories_20260406_231853` TO `favorite_categories`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_favorite_entries_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_favorite_entries_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  userId VARCHAR(64),
  categoryId VARCHAR(64),
  productId VARCHAR(64),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_favorite_entries_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `favorite_entries`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `favorite_entries` TO `__schema_sync_old_favorite_entries_20260406_231853`, `__schema_sync_new_favorite_entries_20260406_231853` TO `favorite_entries`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_clients_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_clients_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  userId VARCHAR(64),
  name VARCHAR(255),
  email VARCHAR(255),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_clients_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `clients`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `clients` TO `__schema_sync_old_clients_20260406_231853`, `__schema_sync_new_clients_20260406_231853` TO `clients`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_vendors_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_vendors_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  userId VARCHAR(64),
  name VARCHAR(255),
  contact VARCHAR(255),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_vendors_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `vendors`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `vendors` TO `__schema_sync_old_vendors_20260406_231853`, `__schema_sync_new_vendors_20260406_231853` TO `vendors`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_equipment_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_equipment_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  userId VARCHAR(64),
  name VARCHAR(255),
  serial VARCHAR(120),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_equipment_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `equipment`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `equipment` TO `__schema_sync_old_equipment_20260406_231853`, `__schema_sync_new_equipment_20260406_231853` TO `equipment`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_equipment_images_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_equipment_images_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  equipmentId VARCHAR(64),
  url TEXT,
  isPrimary TINYINT(1) DEFAULT 0,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_equipment_images_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `equipment_images`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `equipment_images` TO `__schema_sync_old_equipment_images_20260406_231853`, `__schema_sync_new_equipment_images_20260406_231853` TO `equipment_images`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_accounting_codes_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_accounting_codes_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  userId VARCHAR(64),
  code VARCHAR(120),
  description VARCHAR(255),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_accounting_codes_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `accounting_codes`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `accounting_codes` TO `__schema_sync_old_accounting_codes_20260406_231853`, `__schema_sync_new_accounting_codes_20260406_231853` TO `accounting_codes`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_customers_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_customers_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  name VARCHAR(255),
  email VARCHAR(255),
  phone VARCHAR(50),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_customers_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `customers`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `customers` TO `__schema_sync_old_customers_20260406_231853`, `__schema_sync_new_customers_20260406_231853` TO `customers`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_inventory_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_inventory_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  sku VARCHAR(100),
  location VARCHAR(120),
  onHand INT,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_inventory_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `inventory`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `inventory` TO `__schema_sync_old_inventory_20260406_231853`, `__schema_sync_new_inventory_20260406_231853` TO `inventory`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_promotions_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_promotions_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  code VARCHAR(100),
  type VARCHAR(50),
  value DECIMAL(10,2),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_promotions_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `promotions`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `promotions` TO `__schema_sync_old_promotions_20260406_231853`, `__schema_sync_new_promotions_20260406_231853` TO `promotions`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_payments_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_payments_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  orderId VARCHAR(64),
  method VARCHAR(60),
  externalId VARCHAR(255),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_payments_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `payments`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `payments` TO `__schema_sync_old_payments_20260406_231853`, `__schema_sync_new_payments_20260406_231853` TO `payments`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_payment_methods_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_payment_methods_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  userId VARCHAR(64),
  label VARCHAR(255),
  type VARCHAR(50),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_payment_methods_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `payment_methods`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `payment_methods` TO `__schema_sync_old_payment_methods_20260406_231853`, `__schema_sync_new_payment_methods_20260406_231853` TO `payment_methods`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_shipments_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_shipments_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  orderId VARCHAR(64),
  carrier VARCHAR(100),
  tracking VARCHAR(120),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_shipments_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `shipments`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `shipments` TO `__schema_sync_old_shipments_20260406_231853`, `__schema_sync_new_shipments_20260406_231853` TO `shipments`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_analytics_reports_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_analytics_reports_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  name VARCHAR(255),
  period VARCHAR(50),
  metric VARCHAR(100),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_analytics_reports_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `analytics_reports`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `analytics_reports` TO `__schema_sync_old_analytics_reports_20260406_231853`, `__schema_sync_new_analytics_reports_20260406_231853` TO `analytics_reports`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_content_pages_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_content_pages_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  title VARCHAR(255),
  slug VARCHAR(255),
  status VARCHAR(50),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_content_pages_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `content_pages`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `content_pages` TO `__schema_sync_old_content_pages_20260406_231853`, `__schema_sync_new_content_pages_20260406_231853` TO `content_pages`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_pages_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_pages_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  slug VARCHAR(100) NOT NULL UNIQUE,
  title VARCHAR(255) NOT NULL,
  template VARCHAR(50) DEFAULT ''custom'',
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_pages_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `pages`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `pages` TO `__schema_sync_old_pages_20260406_231853`, `__schema_sync_new_pages_20260406_231853` TO `pages`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_page_sections_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_page_sections_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  pageId VARCHAR(64) NOT NULL,
  sectionType VARCHAR(50) NOT NULL,
  content JSON,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_page_sections_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `page_sections`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `page_sections` TO `__schema_sync_old_page_sections_20260406_231853`, `__schema_sync_new_page_sections_20260406_231853` TO `page_sections`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_users_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_users_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  name VARCHAR(255),
  lastName VARCHAR(120),
  email VARCHAR(255),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_users_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `users`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `users` TO `__schema_sync_old_users_20260406_231853`, `__schema_sync_new_users_20260406_231853` TO `users`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_integrations_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_integrations_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  name VARCHAR(255),
  type VARCHAR(100),
  status VARCHAR(50),
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_integrations_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `integrations`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `integrations` TO `__schema_sync_old_integrations_20260406_231853`, `__schema_sync_new_integrations_20260406_231853` TO `integrations`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_settings_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_settings_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  `key` VARCHAR(100),
  `value` TEXT,
  updatedAt DATETIME
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_settings_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `settings`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `settings` TO `__schema_sync_old_settings_20260406_231853`, `__schema_sync_new_settings_20260406_231853` TO `settings`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_rate_limit_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_rate_limit_20260406_231853` (
  id VARCHAR(255) PRIMARY KEY,
  identifier VARCHAR(255) NOT NULL,
  type VARCHAR(50) NOT NULL,
  attempts INT NOT NULL DEFAULT 0,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_rate_limit_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `rate_limit`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `rate_limit` TO `__schema_sync_old_rate_limit_20260406_231853`, `__schema_sync_new_rate_limit_20260406_231853` TO `rate_limit`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_reliability_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_reliability_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  type VARCHAR(50),
  status VARCHAR(50),
  message TEXT,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_reliability_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `reliability`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `reliability` TO `__schema_sync_old_reliability_20260406_231853`, `__schema_sync_new_reliability_20260406_231853` TO `reliability`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
...
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'DROP TABLE IF EXISTS `__schema_sync_new_remember_me_tokens_20260406_231853`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'CREATE TABLE `__schema_sync_new_remember_me_tokens_20260406_231853` (
  id VARCHAR(64) PRIMARY KEY,
  userId VARCHAR(64) NOT NULL,
  tokenHash VARCHAR(128) NOT NULL,
  expiresAt DATETIME NOT NULL,
...
SET @sql := IF(@table_exists = 1 AND @cols IS NOT NULL AND @cols <> '', CONCAT('INSERT INTO `__schema_sync_new_remember_me_tokens_20260406_231853` (', @cols, ') SELECT ', @cols, ' FROM `remember_me_tokens`'), 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
SET @sql := IF(@table_exists = 1, 'RENAME TABLE `remember_me_tokens` TO `__schema_sync_old_remember_me_tokens_20260406_231853`, `__schema_sync_new_remember_me_tokens_20260406_231853` TO `remember_me_tokens`', 'SELECT 1');
PREPARE stmt FROM @sql; EXECUTE stmt; DEALLOCATE PREPARE stmt;
