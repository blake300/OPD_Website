-- OPD schema sync (exact, destructive)
-- Drops and recreates tables to match schema.sql exactly.
...
DROP TABLE IF EXISTS `cart_accounting`;
DROP TABLE IF EXISTS `order_items`;
DROP TABLE IF EXISTS `order_accounting`;
DROP TABLE IF EXISTS `favorites`;
DROP TABLE IF EXISTS `favorite_categories`;
DROP TABLE IF EXISTS `favorite_entries`;
